...
*                                                                      *
*     purpose:  ksi_minus production in  K- + p -->  KSI + K+          *
*     K- n --> KSI K0, K0 n --> KSI K+,
...
************************************************************************
      ...
      integer ireac
      parameter (radmax = 0.07 * 10.0) ! 0.07-> 0.15 mb (max-cross section)
...
*     look for a scattering pseudonucleon in the same run
  ...
  600     i2  = i2 + 1
     ...
     1                                          goto 600
          ...
          id2 = id(1,i2)
          if (id2 .ne. 1) goto 600        !only nucleons
          x2 = r(1,i2)
          dx     = x1 - x2
          if(nbound.eq.1) then
            dxp = dx+2.0*boxx
